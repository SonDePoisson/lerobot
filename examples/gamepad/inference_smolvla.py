...
"""
Run a trained smolVLA policy on the SO-101 robot using EE-space actions.
...
Usage:
  python examples/gamepad/inference.py
"""
...
# ── Configuration ─────────────────────────────────────────────────────────────
MODEL_PATH = "outputs/train/smolvla_gamepad/checkpoints/last/pretrained_model"
